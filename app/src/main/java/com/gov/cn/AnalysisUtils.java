...
//	 *
//	 * @param app
//	 * @param appPromotionType
//	 */
//	public void requestAppPromotion(String app,
//			AppPromotionType appPromotionType) {
//		Map<String, String> data = new HashMap<String, String>();
//		data.put(appPromotionType.str, app);
//		MobclickAgent.onEvent(context, EVENT_APP_PROMOTION, data);
//	}
//
...
//	 * @param open
//	 */
//	public void requestTranslationSwitcher(boolean open) {
//		Map<String, String> data = new HashMap<String, String>();
//		data.put(EVENT_SETTINGS_TRANSLATION, String.valueOf(open));
